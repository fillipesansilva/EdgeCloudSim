...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			applicationsFile = "scripts/sample_app1/config/applications_test.xml";
			
			//edgeDevicesFile = "scripts/sample_app1/config/edge_devices_rpi3.xml";
			edgeDevicesFile = "scripts/sample_app1/config/edge_devices_test.xml";
